      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="flex gap-4">
            ...
            <a href="#" aria-label="Github" className="w-9 h-9 rounded-full bg-white/5 border border-white/10 text-slate-300 hover:border-forsythia hover:text-forsythia flex items-center justify-center transition-colors duration-200">
