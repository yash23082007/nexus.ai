      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="flex gap-4">
            <a href="#" aria-label="Twitter" className="w-9 h-9 rounded-full bg-white/5 border border-white/10 text-slate-300 hover:border-forsythia hover:text-forsythia flex items-center justify-center transition-colors duration-200">
            ...
            <a href="https://github.com/yash23082007/nexus.ai.git" target="_blank" rel="noopener noreferrer" aria-label="Github" className="w-9 h-9 rounded-full bg-white/5 border border-white/10 text-slate-300 hover:border-forsythia hover:text-forsythia flex items-center justify-center transition-colors duration-200">
            ...
            <a href="#" aria-label="LinkedIn" className="w-9 h-9 rounded-full bg-white/5 border border-white/10 text-slate-300 hover:border-forsythia hover:text-forsythia flex items-center justify-center transition-colors duration-200">
        ...
        <div className="flex flex-col gap-4">
          ...
          <nav aria-label="Footer Product links">
            <ul className="space-y-3 text-sm font-medium">
              ...
              <li><a href="#pricing" className="text-slate-400 hover:text-white transition-colors duration-200">Pricing Plans</a></li>
              <li><a href="#features" className="text-slate-400 hover:text-white transition-colors duration-200">Integrations</a></li>
              <li><a href="#metrics" className="text-slate-400 hover:text-white transition-colors duration-200">Uptime SLA</a></li>
            </ul>
          </nav>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <nav aria-label="Footer Resources links">
            <ul className="space-y-3 text-sm font-medium">
              ...
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors duration-200">Guides & Tutorials</a></li>
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors duration-200">API Reference</a></li>
              <li><a href="#" className="text-slate-400 hover:text-white transition-colors duration-200">Developer Forum</a></li>
            </ul>
          </nav>
        </div>
